...
% \end{equation}
% Where $M$ is the mass of the fluid $[kg]$, $v$ is the velocity of the fluid $\left[\frac{m}{s}\right]$ and the resultant forces $F_{in}$, $F_r$ and $F_{out}$ $[N]$.  
...
%The equation \ref{eq:pipe_newton} is expressing that the fluid mass multiplied with the fluid acceleration is equal to the resultant force.\\
%The mass of the fluid can be expressed as: 
%\begin{equation}
...
The velocity of the fluid is written as,
\begin{equation}
v=\frac{Q}{A} 
\end{equation}
