...
\end{aligned}	
\end{equation}
The pressure force acting on the right side, at a height $h_l$ from the channel bed, is given by $F_{P1}$ and $F_{P2}$, where the last term is the added force due to the fluid above the height $h_l$, and gives:  \fxnote{Forstaar ikke lige det her, Jacob}
