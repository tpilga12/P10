...
Instead side input to the main sewer line is assumed attached at the start of the pipe section as shown in table \ref{tab:kloak_diameter}. Further details of sewer interconnection can be found in section \ref{se:sewer_interconnection}. 
