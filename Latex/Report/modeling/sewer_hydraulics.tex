...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{report/modeling/pictures/momentum_picture.pdf}
\caption{Illustration of the control volume $\Omega$, .}
\label{fig:momentum_picture}
\end{figure}\fxnote{fix billede}
...
If an infinite small slice of cross section in the control volume is considered, see at the ends of the pipe in figure \ref{fig:momentum_picture}, and utilizing the product rule on the hydrodynamic force acting on the slice, the following is obtained:  
