...
% \end{equation}
Where \textit{in} denote the force to to the left side on figure \ref{fig:momentum_picture} and \textit{out} is the force to the right side on figure \ref{fig:momentum_picture}. 
