...
where $\mathcal{M}$(t) is the momentum, mass times velocity, of the control volume at time t and F(t) is the various external forces affecting the control volume.
