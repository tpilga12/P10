...
and replacing the flow Q with a flux term, the following is obtained:
...
Where $\phi$ is flux [$\frac{g}{s}$] and $q_c$ is lateral flux input to the control volume [$\frac{g}{s\cdot m}$] \cite{vestergaard1989numerical}.
