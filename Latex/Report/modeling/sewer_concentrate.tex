...
Where $\phi$ is a flux [$\frac{g}{s}$] term replacing the flow term, $Q$ and $q_c$ is lateral flux input to the control volume [$\frac{g}{s\cdot m}$] replacing the lateral inflow term $q$  \cite{vestergaard1989numerical}.
