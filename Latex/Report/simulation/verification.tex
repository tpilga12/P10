...
An initialization scheme is constructed as per figure \ref{fig:simple_sewer} where adjoint pipes are considered as one part of the system and each tank is an individual part, which means that tanks are used as a separator between parts consisting of pipes.
