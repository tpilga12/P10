...
Once again iteration and part index is used to fetch previous values of height and concentrate level, used in calculation of new values. The value of pipe\_comp is used as index in ``pipe\_spec''.