...
For the first part, a simple system setup is decided upon, where the desired components are added to a list. The order of the components in the list then decides the place to be in the system when simulating. An example of this  setup procedure is shown in figure \ref{fig:sys_setup}. \fxnote{} 
