...
As area and flow is already found by solving the Saint-Venant equations by the Preissmann scheme in section \ref{se:preissmann_scheme} a simple discretization of the transport equation suffices.
