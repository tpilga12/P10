...
The numerical method chosen, for solving the Saint-Venant equations,% described in section \ref{se:hydraulics_of_sewer_line}, 
...
\end{equation}
$Q_f$ is calculated from Mannings eqaution shown in \ref{Manning_formula} and can be seen in equation \ref{Manning_formulav2} in appendix \ref{app:formulas}. \fxnote{skal der skrives her, at det er antaget at friction er lig med haeldning?}  \fxnote{lav hjaelpe formeller}
...
In the following stability and precision for the Preissmann scheme will be elaborated. Furthermore, how to chose $\Delta t, \Delta x$ and $\theta$ will be explained. 
