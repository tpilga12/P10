...
Unfortunately concentrate measurements were not available from the industry. For that reason it is decided to lessen focus on the various chemicals and implement it as a single component. Measurements is available from the inflow to the WWTP, but due to the dispersion of the concentrate happening from the industry to the WWTP, it is not possible to recreate a proper profile for the industry. 
