...
From figure \ref{fig:kloakgrid_simplified} it can be seen that 11 different flow profiles needs to constructed to cover each residential area. Each of these residential and industrial areas have been measured on a map to give an estimate of the area for each zone. In table ???? the size of the residential and industrial areas are shown. 

Tabel af størrelse på områder. Vi viser vel en flow profil i rapporten og resten i appendix?

By knowing the area and assuming that the density of population is the same across the city then a flow profile can be scale to each of the residential and industrial areas. From one of the pumping stations, the one located at Thulesvej, a measurement is obtained that illustrates the flow from that zone. This will be used to construct a flow profile according to the area that this pumping station is covering.  

The residential areas denoted with one in figure \ref{fig:sewer_line_diagram}, stretch across a longer sewer line. Where the sewage have to be transported a longer distance from the zone furthest away before reaching the main sewer line. Than the zones closet to the main sewer line. It is chosen to make two flow profiles, one from the residential area and industrial area right next to the main sewer line, and one for the rest of the zones. These two flow profiles will be add together. The industrial area consists mainly of auto shops, recycle factory and workshops and therefore they will have a flow profile similar to the one for residential, however the two peaks at morning and afternoon will be removed, as the shops have not opened and therefore only limited water is used from these places.   

From the second zone only one flow profile will be used and as the zone is so close to main sewer line no delay in the profile is added. At zone three the distance from the residential area to the main sewer line is long, and therefore a delay will be added on the flow profile for that area. The fourth zone covers a larger area and as some of the residential are far away from the main sewer line, and therefore the flow profile is extended in the peaks. Also here the industrial are consists of grocery stores, workshops and car shops and therefore will have the same profile as the one from the first industrial zone. 

Zone five and six will have a normal profiles without delays. Zone seven will have a profile with delay as it also stretch across a long sewer line before reaching the main sewer line. Zone eight, nine and eleven will have the same profile, and the industrial area is the same as the one in zone four. 

From zone ten a pump is pumping the wastewater to the main sewer line every 30 minuted for a period of 15 minutes. The pump has a pumping capacity of 0,350 $m^3/s$ KILDE. Therefore the flow profile for this area will be a constant input of 0,350 $m^3/s$ for 15 minutes every 30 minuted.     