...
In appendix \ref{app:flow_profiles} figure \ref{fig:COD_data}, \ref{fig:Forfos_data} and \ref{fig:kvaelstof_data} show COD, phosphorus and nitrogen measurements respectively from inflow to the WWTP. 
