...
From the figure it can be seen how the flow into the WWTP fluctuates. From 00:00 to 03:25 the flow fluctuates between 1000 $m^3/hr$ to 1200 $m^3/hr$ and these huge shirts in flow rate is ongoing the entire day. Around 07:00 a large shift in flow occur, it is unknown if this is a false measurement or it is due to a huge load change, as this peck seems to be only for one sample. However, it is very clear that the flow fluctuates across the entire day and it would be desirable to smooth the flow out.    