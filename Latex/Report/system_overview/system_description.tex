...
In appendix \ref{app:flow_profiles} figures \ref{fig:Forfos_data}, \ref{fig:Forfos_data} and \ref{fig:kvaelstof_data}  COD, phosphorus and nitrogen measurements from the input to the WWTP is shown. These figures show a similar pattern as the flow measurement, however, they do not vary as much as the flow. But a direct comparison cannot be done, as these measurements, the concentration measurements and the flow measurement, are measured at different dates, and therefore it can not be concluded if these concentrations are varying as much as the flow measurement. However, it can be concluded that these measurements also fluctuates across a day and therefore needs to be smoothed out to obtain a better cleansing process at the WWTP. 
