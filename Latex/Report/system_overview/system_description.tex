...
The residential area 1,1 is used to obtain an approximate density of people per square kilometer within the urban areas. The number of houses located in this area is found to be 199 which gives an average urban population density of 3098,2 per square kilometer.
...
From the figure, it can be seen that the flow from industry is in pulses of up to 200 $m^3/hr$ where the longest pulse is around an hour and the shortest is around 10 minutes. Between the pulse the flow is limited and the duration of these zones are most often around 30 minutes. From the figure, it could indicate that there are two pumps pumping the wastewater away from the industry, as there are two levels in the plot. Around 190-200 $m^3/hr$ and around 110-120 $m^3/hr$. This data will be used to create the input to the main sewer line from the industry.     
