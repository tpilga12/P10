...
Fungi like bacteria decomposes the organic waste, however they also pose a significant problem for the treatment process as the fungi can proliferate to an extent where it affects the effluent quality of the wastewater \fxnote{er det wastewater eller renset vand?} \cite{fungi_source}. 
