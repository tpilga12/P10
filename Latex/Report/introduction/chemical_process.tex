...
Wastewater are subject to a variety of mass changes in sewers. This is caused by free electrons in the wastewater, which causes chemical reactions and thereby leading to new compounds being created. %These results in different compounds being created.
...
%In the following section it will be shown how a daily input flow to the WWTP would like and what effects it can have on the cleansing process. Furthermore the problems that comes with the industry will be explained. 
