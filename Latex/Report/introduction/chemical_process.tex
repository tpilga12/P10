...
It is wanted to have a smooth as possible input into the WWTP to keep this aeration phase as constant as possible. Thereby reducing the energy cost in this phase and gain a more optimal purify process. Thereby obtaining a better water quality at the output of the plant. Furthermore the it is wanted to attenuate the concentration of the matter from the industry to a level where the WWTP can handle it. 
...
Løsningsmetode med at indsætte buffer tanke
