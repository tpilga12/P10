...
The WWTP in Fredericia purifies wastewater from the industry and the households. A daily intake of wastewater is illustrated in figure  
...
It is illustrated how varying the flow across a day is. Therefore the treatment process in the WWTP is also affect by this change of flow. Especially the aeration phase where the process requires power to drive the pumps that create this oxygenation of the water. This process will follow the input flow to accommodate the change. Because when the input is high the process requires a higher population of microorganisms to purify the wastewater, and therefore more air is needed in the wastewater. 

Therefore it is wanted from Fredericia to have a smooth as possible input into the WWTP to keep this aeration phase as constant as possible. Thereby reducing the energy cost in this phase and gain a more optimal purify process. 
