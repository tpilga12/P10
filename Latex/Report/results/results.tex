...
The second tank is placed just before the WWTP with the purpose of smoothing the flow into the WWTP. %However, in this simulation, the tanks will just transfer wastewater from the previous pipe to the pipe after the tank, due to the MPC controller is not able to control them optimally. 
