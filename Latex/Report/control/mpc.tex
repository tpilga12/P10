...
However, to make the constraint depend on $\Delta \CMcal{U}$ the difference between the current timestep and the previous timestep, $\Delta \CMcal{U}(k) = \Delta u(k)-\Delta u(k-1)$, is inserted on the state, input and disturbance: 
...
\begin{equation}
 ...
 \begin{equation}
       \underbrace{\underline{x}- \bar{x}-\CMcal{A}(\Delta\hat{x}(k)+ x(k-1))-\CMcal{B}(\Delta\CMcal{D}(k)+\CMcal{D}(k-1))-\CMcal{B}u(k-1)}_{x_1}\  \leq \CMcal{B}\Delta\CMcal{U}
 \end{equation}  

 \begin{equation}
     \underbrace{\overline{x}-\bar{x}-\CMcal{A}(\Delta\hat{x}(k)+ x(k-1))-\CMcal{B}(\Delta\CMcal{D}(k)+\CMcal{D}(k-1))-\CMcal{B}u(k-1)}_{x_2}\geq \CMcal{B}\Delta\CMcal{U}
 \end{equation}
