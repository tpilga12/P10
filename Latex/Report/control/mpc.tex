...
-\sum_{i=1}^n \Delta\CMcal{U}(k+i) &\leq \underbrace{\CMcal{U}(k-1)-u_{min}+\bar{u}}_{\Gamma_3}
 \end{aligned}
 \end{equation}
...
And the upper bound:
 ...
 \begin{aligned}
				...
				\sum_{i=1}^n \Delta\CMcal{U}(k+i)  &\leq  \underbrace{u_{max} -  \bar{u} - \CMcal{U}(k-1)}_{\Gamma_4} \\
 \end{aligned}
 \end{equation}
