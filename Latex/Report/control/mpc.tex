...
\begin{equation}
 ...
 \begin{equation}
       \underbrace{\underline{x}- \bar{x}-\CMcal{A}x(k)-\CMcal{B}\CMcal{U}(k-1)-\CMcal{B}\CMcal{D}(k)}_{\Gamma_1}  \leq \CMcal{B}\sum_{i=1}^n \Delta\CMcal{U}(k+i)
 \end{equation}  
...
The constraint is split up into lower and upper bound for the signal, the lower bound is:

 \begin{equation}
 \begin{aligned}
			 	u_{min} -  \bar{u} &\leq \CMcal{U}(k-1)+\sum_{i=1}^n \Delta\CMcal{U}(k+i) \\
-\sum_{i=1}^n \Delta\CMcal{U}(k+i) &\leq \underbrace{\CMcal{U}(k-1)-u_{min}+\bar{u}}_{\Gamma_2}
 \end{aligned}
 \end{equation}
