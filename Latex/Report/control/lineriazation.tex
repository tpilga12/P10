...
Furthermore in the tabular \ref{tab:system_setup_nonlinear_linear_test} the system setup is shown.
...
It can be seen that the setup consist of 19 pipes and one tank, where the tank is placed after the first pipe in the setup. The input to the sewer network from the tank is a sinus wave as is shown in figure \ref{fig:height_input_for_comparision}.  
