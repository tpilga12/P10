...
\end{equation}
\fxnote{Der skal ikke stå 72, der skal stå mannings coefficienten og sikkert andre fixes engang i nat.}
...
\begin{equation}%\label{eq:qf_for_flow}
	Q_{f} =72\pi\left(\frac{d}{2}\right)^2\left(\frac{d}{4}\right)^{0.635} S_f^{0,5}% -3.02 \cdot ln\left(\frac{0.74\cdot 10^{-6}}{d\sqrt{d\cdot I_e}}+\frac{k}{3.71\cdot d}\right)d^2\sqrt{d\cdot I_e}
\end{equation}
