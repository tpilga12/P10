...
{Control of Photovoltaic and Diesel Hybrid System}

%\subtitle{Total fizz}  % could also be a conference name

\date{December 22, 2016}

\author[Group 731] % optional, use only with lots of authors
{
	Group 731 \\
...
%%%%%%%%%%%%%%%%
\input{Sections/part1_main.tex}
%%%%%%%%%%%%%%%%
\input{Sections/part2_main.tex}
