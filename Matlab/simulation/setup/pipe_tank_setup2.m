...
%%%%%%%%%%%%%%%%%% pipe1.1 %%%%%%%%%%%%%%
    ...
    pipe.sections = 50;%15; % Number of sections,
...
%%%%%%%%%%%%%%%%%% pipe1.2 %%%%%%%%%%%%%%
    ...
    pipe.sections = 3;%1; % Number of sections,
    pipe.Dx = pipe.length/pipe.sections; %[m] grid distance
    pipe.Ib = 0.003; %bed slope
    pipe.d = 1; %[m] Diameter
    pipe.k=0.0015; %sandruhed angives typisk i mm der skal bruges m i formler
...
%%%%%%%%%%%%%%%%%% pipe2.1 %%%%%%%%%%%%%%
    ...
    pipe.sections = 24;%8; % Number of sections,
    pipe.Dx = pipe.length/pipe.sections; %[m] grid distance
...
%%%%%%%%%%%%%%%%%% pipe2.2 %%%%%%%%%%%%%%
    ...
    pipe.sections = 42;%14; % Number of sections,
    pipe.Dx = pipe.length/pipe.sections; %[m] grid distance
...
%%%%%%%%%%%%%%%%%% pipe2.3 %%%%%%%%%%%%%%
    ...
    pipe.sections = 45;%15; % Number of sections,
    pipe.Dx = pipe.length/pipe.sections; %[m] grid distance
...
%%%%%%%%%%%%%%%%%% pipe3.1 %%%%%%%%%%%%%%
    ...
    pipe.sections = 15;%5; % Number of sections,
    pipe.Dx = pipe.length/pipe.sections; %[m] grid distance
...
%%%%%%%%%%%%%%%%%% pipe4.1 %%%%%%%%%%%%%%
    ...
    pipe.sections = 6;%2; % Number of sections,
    pipe.Dx = pipe.length/pipe.sections; %[m] grid distance
...
%%%%%%%%%%%%%%%%%% pipe5.1 %%%%%%%%%%%%%%
    ...
    pipe.sections = 90;%30; % Number of sections,
    pipe.Dx = pipe.length/pipe.sections; %[m] grid distance
    pipe.Ib = 0.003; %bed slope
    pipe.d = 1; %[m] Diameter
    pipe.k=0.0015; %sandruhed angives typisk i mm der skal bruges m i formler
...
%%%%%%%%%%%%%%%%%% pipe6.1 %%%%%%%%%%%%%%
    pipe.length = 155; % length in meter
    pipe.sections = 21;%7; % Number of sections,
    pipe.Dx = pipe.length/pipe.sections; %[m] grid distance
...
%%%%%%%%%%%%%%%%%% pipe6.2 %%%%%%%%%%%%%%
    ...
    pipe.sections = 120;%40; % Number of sections,
    pipe.Dx = pipe.length/pipe.sections; %[m] grid distance
...
%%%%%%%%%%%%%%%%%% pipe8.1 %%%%%%%%%%%%%%
    ...
    pipe.sections = 36;%12; % Number of sections,
    pipe.Dx = pipe.length/pipe.sections; %[m] grid distance
...
%%%%%%%%%%%%%%%%%% pipe10.1 %%%%%%%%%%%%%%
    ...
    pipe.sections = 18;%6; % Number of sections,
    pipe.Dx = pipe.length/pipe.sections; %[m] grid distance
    pipe.Ib = 0.0021; %bed slope
...
%%%%%%%%%%%%%%%%%% pipe10.2 %%%%%%%%%%%%%%
    ...
    pipe.sections = 12;%4; % Number of sections,
    pipe.Dx = pipe.length/pipe.sections; %[m] grid distance
